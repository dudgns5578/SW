...
print("list1의 자료형 : ", type(list1))

list2 = [1, 'one', (1,2,3), "python"]
print("list2 내용 " ,list2)
print("list2의 자료형 : ", type(list2))

language = 'python'
list3 = list(language)
print("list3 내용 " ,list3)
print("list3의 자료형 : ", type(list3))

tuple1 = (1,2,3,4,5)
list4 = list(tuple1)
print("list4 내용 " ,list4)
print("list4의 자료형 : ", type(list4))
...
print("list5의 자료형 : ", type(list5))

# 1~9까지의 정수를 리스트로 생성하시오.
list6 = list(range(1,10))
print("list6 내용 " ,list6)
print("list6의 자료형 : ", type(list6))
...
print("liist7의 요소 중 최대 값 : ", max(list7))
print("liist7의 요소 중 최소 값 : " ,min(list7))
...
# 3번째로 좋아하는 과일을 출력하시오.
print("세 번째로 출력하는 과일 : ", fruit[2])

# 4번째로 좋아하는 과일을 '두리안'으로 바꾸시오.
fruit[3] = '두리안'  # 2번지에 튜플 삽입(덮어쓰기-교환)
