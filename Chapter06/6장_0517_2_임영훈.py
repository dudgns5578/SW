...
print("text1의 내용의 단어를 대문자로 변환 : ", text2)
...
print("text3에 인덱스 5부터 10까지 중에서 'i'가 몇 개 있나요? ",text3.count('i',5,10))
print("text3에 인덱스 5이후에 'o'가 몇 개 있나요? ",text3.count('o',5))

# 문자열 내의 위치 - index(), fine(), atartswitch(), endswith()
...
# 없으면 오류
# print("text3에 'pytho1'의 인덱스 위치는? ", text3.index('python1'))
# 없으면 -1을 반환(출력)
print("text3에 'pytho1'의 인덱스 위치는? ", text3.find('python1'))
